...
( function( window, $, undefined ) {
	...
	$( '.menu-toggle, .sub-menu-toggle' ).on( 'click.podcast-pro', function() {
		var $button = $( this ),
		...
		$button.next( '.genesis-nav-menu, .sub-menu' ).slideToggle( 'fast' ).attr( 'aria-hidden', ! state );
	});
})( this, jQuery );
