...
add_action( 'wp_enqueue_scripts', 'podcast_pro_enqueue_fonts' );
/**
 * Load fonts.
 *
 * @since 1.0.0
 */
function podcast_pro_enqueue_fonts() {
    wp_enqueue_style( 'podcast-pro-fonts', podcast_pro_fonts_url(), array(), null );
}
 ...
 * @since  1.0.0
 */
function podcast_pro_fonts_url() {
    $fonts_url = '';
    ...
    */
    $oswald = _x( 'on', 'Oswald font: on or off', 'podcast-pro' );

    /* Translators: If there are characters in your language that are not
    * supported by this font, translate this to 'off'. Do not translate
    * into your own language.
    */
    $open_sans = _x( 'on', 'Open Sans font: on or off', 'podcast-pro' );
