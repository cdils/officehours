...
add_action( 'tgmpa_register', 'podcast_pro_register_required_plugins' );
/**
 ...
 */
function podcast_pro_register_required_plugins() {
	...
	$plugins = array(
		...
		// Include Genesis E-News Extended
		array(
